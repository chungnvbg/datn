	...
	<section class="about py-5">
		<div class="container py-xl-5 py-lg-3">
			<div class="title-section mb-md-5 mb-4">
				...
				<h3 class="w3ls-title text-uppercase text-bl font-weight-bold">About Us</h3>
			</div>
			<div class="row">
				<div class="col-lg-6 agileits_works-grid">
					<div class="wthree-bottom">
						<h6 class="subheading-w3ls text-uppercase text-bl mb-4">Sed do eiusmod tempor incididunt ut labore et dolore.</h6>
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6">
					<div class="card border-0 med-blog">
						...
						<div class="card-body border border-top-0">
							<div class="mb-3">
								<h5 class="blog-title card-title m-0">Where ever you are
								</h5>
				...
				<div class="col-lg-4 col-md-6 mt-md-0 mt-5">
					<div class="card border-0 med-blog">
						...
						<div class="card-body border border-top-0">
							<div class="mb-3">
								<h5 class="blog-title card-title m-0">Directly to your card
								</h5>
								<div class="blog_w3icon">
									<span>
										Magna Kictum - loremipsum</span>
				...
				<div class="col-lg-4 col-md-6 mt-lg-0 mt-5">
					<div class="card border-0 med-blog">
						...
						<div class="card-body border border-top-0">
							<div class="mb-3">
								<h5 class="blog-title card-title m-0">It’s Fast and Secure
								</h5>
								<div class="blog_w3icon">
									<span>
										Magna Kictum - loremipsum</span>
