...
<head>
	...
	<!-- Custom-Files -->
	<link rel="stylesheet" href="{{asset('public/layout/frontend/css/bootstrap.css')}}">
	<!-- Bootstrap-Core-CSS -->
	<link href="{{asset('public/layout/frontend/css/css_slider.css')}}" type="text/css" rel="stylesheet" media="all">
	<!-- banner slider -->
	<link rel="stylesheet" href="{{asset('public/layout/frontend/css/style.css')}}" type="text/css" media="all" />
	<!-- Style-CSS -->
	<link href="{{asset('public/layout/frontend/css/font-awesome.min.css')}}" rel="stylesheet">
						...
						<div class="col-xl-5 col-lg-6 col-md-8 top-social-agile text-lg-left text-center">
							<div class="row">
								<div class="col-4 header-top_w3layouts">
									<p class="text-bl">
										<span class="fa fa-map-marker mr-2"></span>Sơn tây
									</p>
								</div>
								<div class="col-4 header-top_w3layouts">
									<p class="text-bl">
						...
						<div class="col-xl-7 col-lg-6 col-md-4 top-social-agile text-md-right text-center mt-md-0 mt-2">
							<div class="row">
								...
								<div class="col-xl-3 col-lg-4 col-6 top-w3layouts p-md-0 text-right">
									<!-- login -->
									<a href="{{asset('loginClient')}}" class="login-button-2 text-uppercase text-bl">
										<span class="fa fa-sign-in mr-2"></span>Đăng nhập</a>
									<!-- //login -->
								</div>
								<div class="col-xl-3 col-lg-4 col-6 header-w3layouts text-md-right text-left">
									<!-- register -->
									<a href="{{asset('register')}}" class="login-button-2 text-uppercase text-bl">
										<span class="fa fa-pencil-square-o mr-2"></span>Đăng kí</a>
									<!-- //register -->
								</div>
							</div>
						</div>
