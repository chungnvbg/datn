...
@section('main')
           ...
           <meta charset="utf-8">
            <div class="outer-w3-agile mt-3">
                    <h4 class="tittle-w3-agileits mb-4">Chào Mừng Bạn Đến Với Chúng Tôi</h4>
                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img class="d-block w-100" src="{{asset('local/resources/views/backend/images/ban7.jpg')}}" alt="First slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="{{asset('local/resources/views/backend/images/ban8.jpg')}}" alt="Second slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="{{asset('local/resources/views/backend/images/ban9.jpg')}}" alt="Third slide">
                            </div>
                        </div>
