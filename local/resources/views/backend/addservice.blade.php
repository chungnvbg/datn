...
<div class="outer-w3-agile mt-3">
                    <h4 class="tittle-w3-agileits mb-4">Thêm dịch vụ</h4>
                    <form method="post">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="inputEmail4">Tiêu đề</label>
                                <input type="text" class="form-control" id="inputEmail4" placeholder="tiếu đề" required="">
                            </div>
                            <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="content" class="form-control" id="inputAddress" placeholder="content" required="">
                            </div>
                            <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6">
                                 ...
                                 <input type="text" class="form-control" id="inputAddress2" placeholder="dd/mm/yy" required="">
                            </div>
